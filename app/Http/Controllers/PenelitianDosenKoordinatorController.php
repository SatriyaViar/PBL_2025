...
class PenelitianDosenKoordinatorController extends Controller
{
    ...
    {
        $dataDosen = UserModel::with('level')
    ...
    public function edit($id)
    {
        ...
        $selectedDosenIds = LecturerResearchModel::where('penelitian_id', $penelitian->id_penelitian)
            ->pluck('user_id')
            ->toArray();
